...
<style>
    #userDataList th {
        ...
        /* Canh giữa tiêu đề */
        /* overflow: hidden; */
        /* Ẩn bất kỳ nội dung thừa nào */
        text-overflow: ellipsis;
        /* Nếu cần, có thể thêm dấu ba chấm "..." cho nội dung dài */
    }

    #userDataList td {
        white-space: nowrap;
        /* Ngăn không cho nội dung xuống dòng trong các ô dữ liệu */
        text-overflow: ellipsis;
        /* overflow: hidden; */
    }
</style>
...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
        ...
        <div class="row filter-row">
            ...
            <div class="col-sm-6 col-md-3">
                <button type="submit" class="btn btn-success btn-block btn_search"> Tìm kiếm </button>
            </div>
        </div>
                ...
                <div class="modal-body">
                    <form action="{{ route('update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <label>Vị trí</label>
                                <select class="select" name="designation" id="e_designation">
                                    @foreach ($designations as $designation )
                                    <option value="{{ $designation->id }}">{{ $designation->name }}</option>
                                    @endforeach
                                </select>
...
<script>
    $(document).on('click', '.userUpdate', function() {
        ...
        const departmentId = _this.find('.department').attr('department_id');
        $('#e_department').select2("val", departmentId);
        const designationId = _this.find('.designation').attr('designation_id');
        $('#e_designation').select2("val", designationId);
